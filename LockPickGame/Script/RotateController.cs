...
public class LockPickRotation : MonoBehaviour
{
    ...
    //handle the stick
    public Transform lockPick; // Assign CayLockPick_0 
    public float rotationSpeed = 5f; // Adjust for sensitivity
    ...
    public Transform innerLock; // Assign innerLock
    ...
    void HandlePickRotation()
    {
        ...
        if (Input.GetMouseButton(0) && isRotating)
        {
            ...
            //
            //lockPick.Rotate(Vector3.forward, rotationAmount); // Rotate around Z-axis
